...
from ...adapters.mixins.electra import ElectraModelAdaptersMixin, ElectraOutputAdaptersMixin, ElectraSelfOutputAdaptersMixin
...
class ElectraForCausalLM(ModelWithHeadsAdaptersMixin, ElectraPreTrainedModel):
    ...
    def forward(
        ...
        prediction_scores = self.generator_lm_head(
            self.electra.invertible_adapters_forward(
